...
public class NetworkListener extends Listener{
	public void received (Connection connection, Object object) {
        if (object instanceof PacketConsoleMessage){
    		...
    		NetworkPlayer newPlayer = new NetworkPlayer(GDXServer.PlayerList.size(),
									    				ph.name,
									    				new Vector2(0,0),
									    				0f,
									    				new Vector2(0,0),
    		 ...
    		 *but i don't know how kryo handles id's and if for some reason it can colide with a previous value*/
